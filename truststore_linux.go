...
func (m *simbacert) systemTrustFilename() string {
	return fmt.Sprintf(SystemTrustFilename, strings.Replace(m.caUniqueName(), " ", "_", -1))
}

func (m *simbacert) installPlatform() bool {
...
func (m *simbacert) uninstallPlatform() bool {
	if SystemTrustCommand == nil {
		return false
	}
	...
	legacyFilename := fmt.Sprintf(SystemTrustFilename, "simbacert-rootCA")
